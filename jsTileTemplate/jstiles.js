	...
	$.fn[pluginName].templates = {
		...
		tempD: {
			...
			tiles: {
				...
				4: 'col-xs-12 col-sm-12 col-md-12',
				5: 'col-xs-12 col-sm-4 col-md-3',
				6: 'col-xs-12 col-sm-4 col-md-3',
			...
			animations: {
				...
				5: { tlClass:'tl-slide-up', tlClassF:'tl-slide-up-f', tlDelay:200},
				6: { tlClass:'tl-slide-up', tlClassF:'tl-slide-up-f', tlDelay:200},
